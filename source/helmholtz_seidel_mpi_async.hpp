...
// ### MPI parallelization ###
//
// >>> For parallelization scheme check regular MPI version in "helmholtz_seidel_mpi.hpp"
//
// ### Async communication ###
//
...
//
inline UniquePtrArray helholtz_seidel_mpi_async(T k, std::function<T(T, T)> f, T L, size_t N, T epsilon,
